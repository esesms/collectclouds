...
while 1:
    ...
    #To output a poem collection

    #for x in range(20):
    #    if (poem_counter >= (x*100) and poem_counter < ((x*100)+100)):
    #        file_2 = open("poem_collection_" + str(x) + ".txt", "a")
    #        file_2.write(haiku_sum + "\n\n")
